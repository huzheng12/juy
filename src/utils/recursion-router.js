 ...
 */
import router, { website, notFind, btnRoute, global_management, layout, customerService, common, agentplatform, OperatorRouter } from '@/router'
...
export function filterRouter (param, btn) {
  ...
  let agentplatRoutes = recursionRouter(param.site_configuration, agentplatform)
  let OperatorRouterRoutes = recursionRouter(param.site_configuration, OperatorRouter)
  // console.log(sssss)
  ...
  const routeList = common.concat(websiteRoutes, btnRoutes, customerRoutes, oauthRoutes, notFind, agentplatRoutes, OperatorRouterRoutes)
