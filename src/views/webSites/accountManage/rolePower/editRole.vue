  ...
  <div class="role-container">
    ...
    <el-form class="marginTop20"
      ...
      <el-form-item label="角色名称">
        <el-input v-model="this.rolename"
                  clearable></el-input>
      </el-form-item>
      <el-form-item label="角色描述">
        <el-input v-model="this.roledescription"
                  clearable
                  type="textarea"
                  autosize></el-input>
      </el-form-item>
    ...
    <el-tabs type="border-card">
      <el-tab-pane :label="item.name"
                   ...
                   :key="index">
        <el-tree :data="item.treeList"
                 node-key="id"
                 default-expand-all
                 :expand-on-click-node="false"
                 show-checkbox
                 :default-checked-keys="item.selectList"
