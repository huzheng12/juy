<template>
  <div class="role-container">
    ...
    <el-button class="marginTop20"
               icon="el-icon-folder-add"
               v-if="$filterBtnRoute(818)"
    ...
    <el-table ref="singleTable"
      ...
      <el-table-column align="center"
        ...
        <template slot-scope="scope">
          <el-button v-if="$filterBtnRoute(817)"
                     @click="handleView(scope.row)"
                     type="text"
                     size="small">查看</el-button>
          <el-button v-if="$filterBtnRoute(821)"
                     @click="handleEdit(scope.row)"
                     type="text"
                     size="small">编辑</el-button>
          <el-button v-if="$filterBtnRoute(820)"
    ...
    <div class="block">
      <el-pagination @current-change="handleCurrentChange"
                     ...
                     :total="pageParam.total"></el-pagination>
    </div>
    <!-- 分页end -->
    <!-- 对话框start -->
    <el-dialog title="查看角色"
               :visible.sync="dialogFormVisible">
      <el-form :model="form">
        <el-form-item label="角色名称"
                      :label-width="formLabelWidth">
          <el-input v-model="rowArr.name"
                    autocomplete="off"
                    disabled></el-input>
        </el-form-item>
        <el-form-item label="角色描述"
                      :label-width="formLabelWidth">
          <el-input v-model="rowArr.remark"
                    autocomplete="off"
                    type="textarea"
                    autosize
                    disabled></el-input>
