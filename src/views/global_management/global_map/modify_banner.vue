    ...
    <div class="form">
      <el-form ref="form"
        ...
        <el-form-item label="应用类型"
                      prop="applicationTypeDefault">
          <el-select v-model="form.applicationTypeDefault"
                     placeholder="请选择应用类型">
        ...
        <el-form-item label="系统语种"
                      prop="region">
          <el-select v-model="form.region"
                     placeholder="请选择语种">
            <el-option :label="item.name | replaceStr"
                       :value="item.value"
        ...
        <el-form-item label="是否置顶"
                      prop="region">
          <el-select v-model="form.isTopVal"
                     placeholder="请选择">
            <el-option :label="item.name"
                       :value="item.value"
        ...
        <el-form-item label="上传图片">
          <el-upload ref="upload"
            ...
            <img v-if="form.imageUrl"
                 :src="form.imageUrl.indexOf('http')===-1 ? $ALI_OSS_URL + form.imageUrl:form.imageUrl"
                 class="avatar">
            <i v-else
